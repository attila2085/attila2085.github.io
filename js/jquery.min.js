...
!(function (e, t) {
  ...
  var t = "4.0.0-pre a503c691dc06c59acdafef6e54eca2613c6e4032",
    l = /HTML$/i,
    ee = function (e, t) {
  ...
  !(function () {
      ...
      if (!r && (F(e), (e = e || w), T)) {
        if (11 !== p && (u = E.exec(t)))
          if ((i = u[1])) {
            ...
            if (f && (a = f.getElementById(i)) && ee.contains(e, a))
              return K.call(n, a), n;
          } else {
        ...
        if (!(d[t + " "] || (oe && oe.test(t)))) {
          if (((c = t), (f = e), 1 === p && (v.test(t) || g.test(t)))) {
            ((f = (S.test(t) && I(e.parentNode)) || e) !== e || ie) &&
              ((s = e.getAttribute("id"))
                ? (s = ee.escapeSelector(s))
      ...
      return (function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === c.length)) {
          if (
            ...
            if (!(t = (x.find.ID(a.matches[0].replace(D, A), t) || [])[0]))
              return n;
          ...
          ? e.parentNode && !1 === e.disabled
            ? "label" in e
              ? "label" in e.parentNode
                ...
                : e.disabled === t
              : e.isDisabled === t || (e.isDisabled !== !t && N(e) === t)
            : e.disabled === t
    ...
    ((x = ee.expr = {
      ...
      filter: {
        ...
        TAG: function (e) {
          var t = e.replace(D, A).toLowerCase();
          return "*" === e
            ? function () {
                return !0;
              }
              ...
              x.setFilters.hasOwnProperty(e.toLowerCase())
                ? P(function (e, t) {
                    var n,
                      r = a(e, o),
                      i = r.length;
                    while (i--) e[(n = Z.call(e, r[i]))] = !(t[n] = r[i]);
                  })
                : function (e) {
                    return a(e, 0, t);
                  })
      ...
      pseudos: {
        ...
        lang: P(function (n) {
          return (
            p.test(n || "") || O("unsupported lang: " + n),
            (n = n.replace(D, A).toLowerCase()),
            function (e) {
              var t;
              do {
                if (
        ...
        checked: function (e) {
          return (
            (te(e, "input") && !!e.checked) || (te(e, "option") && !!e.selected)
          );
        },
        selected: function (e) {
          return (
            ie && e.parentNode && e.parentNode.selectedIndex, !0 === e.selected
          );
        },
        empty: function (e) {
    ...
    { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
      x.pseudos[e] = R(e);
    for (e in { submit: !0, reset: !0 }) x.pseudos[e] = M(e);
    function B() {}
    function _(e, t) {
      var n,
        r,
      ...
      while (a) {
        ...
        (r = g.exec(a)) &&
          ((n = r.shift()),
          i.push({ value: n, type: r[0].replace(h, " ") }),
          (a = a.slice(n.length))),
        x.filter))
          !(r = y[o].exec(a)) ||
            (u[o] && !(r = u[o](r))) ||
      ...
      return (
        ...
        P(function (e, t, n, r) {
          var i,
            ...
            p = !d || (!e && h) ? f : V(f, u, d, n, r);
          if (
            (g ? g(p, (s = y || (e ? d : c || v) ? [] : t), n, r) : (s = p), v)
          ) {
            (i = V(s, l)), v(i, [], n, r), (o = i.length);
          ...
          if (e) {
            if (y || d) {
              ...
              while (o--)
                (a = s[o]) &&
                  -1 < (i = y ? Z.call(e, a) : u[o]) &&
                  (e[i] = !(t[i] = a));
            }
          } else (s = V(s === t ? s.splice(c, s.length) : s)), y ? y(null, t, s, r) : K.apply(t, s);
        })
      );
    }
    function G(e) {
    ...
    function Q(e, t) {
      ...
      if (!a) {
        t || (t = _(e)), (n = t.length);
        while (n--) (a = G(t[n]))[C] ? i.push(a) : o.push(a);
        (a = s(
          e,
          ((g = o),
          (y = 0 < (v = i).length),
          ...
          (r = function (e, t, n, r, i) {
            ...
            for (i && (b = t == w || t || i); null != (o = d[l]); l++) {
              if (m && o) {
                (a = 0), t || o.ownerDocument == w || (F(o), (n = !T));
                while ((s = g[a++]))
                  if (s(o, t || w, n)) {
                    K.call(r, o);
                    break;
    ...
    (B.prototype = x.filters = x.pseudos),
      (x.setFilters = new B()),
      F(),
      (ee.find = L);
  })();
  var E = ee.expr.match.needsContext,
    S = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  function D(e, n, r) {
  ...
  (ee.filter = function (e, t, n) {
    ...
    ee.fn.extend({
      ...
      is: function (e) {
        return !!D(
          this,
          "string" == typeof e && E.test(e) ? ee(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || A), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          ee.merge(
            this,
            ee.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : C, !0)
          ),
          S.test(r[1]) && ee.isPlainObject(t))
        )
          for (r in t)
      ...
      function (r, i) {
        ee.fn[r] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (O[r] || ee.uniqueSort(n), N.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (ee.Callbacks = function (r) {
    ...
    r =
      "string" == typeof r
        ? ((e = r),
          (n = {}),
          ee.each(e.match(H) || [], function (e, t) {
            n[t] = !0;
          }),
          n)
        : ee.extend({}, r);
    var i,
      ...
      f = {
        ...
        has: function (e) {
          return e ? -1 < ee.inArray(e, s) : 0 < s.length;
        },
        empty: function () {
          return s && (s = []), this;
        },
          ...
          a = {
            ...
            then: function (t, n, r) {
              ...
              return ee
                .Deferred(function (e) {
                  o[0][3].add(
                    l(0, e, "function" == typeof r ? r : P, e.notifyWith)
                  ),
                    o[1][3].add(l(0, e, "function" == typeof t ? t : P)),
                    o[2][3].add(l(0, e, "function" == typeof n ? n : R));
                })
                .promise();
            },
            promise: function (e) {
              return null != e ? ee.extend(e, a) : a;
            },
          },
          s = {};
        return (
  ...
  var $ = ee.Deferred();
  function I() {
    C.removeEventListener("DOMContentLoaded", I),
      J.removeEventListener("load", I),
      ee.ready();
  }
  (ee.fn.ready = function (e) {
    ...
    "loading" !== C.readyState
      ? J.setTimeout(ee.ready)
      : (C.addEventListener("DOMContentLoaded", I),
        J.addEventListener("load", I));
    ...
    ee.fn.extend({
      data: function (n, e) {
        ...
        if (void 0 === n) {
          if (
            this.length &&
            ((i = Y.get(o)), 1 === o.nodeType && !V.get(o, "hasDataAttrs"))
          ) {
            t = a.length;
            while (t--)
              a[t] &&
                0 === (r = a[t].name).indexOf("data-") &&
                ((r = U(r.slice(5))), ue(o, r, i[r]));
  ...
  function ge(e) {
    return de.test(e) && he.test(e[0].toUpperCase() + e.slice(1));
  }
  function ve(e, t, n, r) {
    var i,
      o,
      ...
      u = s(),
      l = (n && n[3]) || (ge(t) ? "px" : ""),
      c = e.nodeType && (!ge(t) || ("px" !== l && +u)) && ce.exec(ee.css(e, t));
    if (c && c[3] !== l) {
      (u /= 2), (l = l || c[3]), (c = +u || 1);
      while (a--)
        ee.style(e, t, c + l),
            ...
            "" === r.style.display &&
              ...
              (l[c] =
                ...
                (u = xe[s]) ||
                  ...
                  "none" === u && (u = "block"),
                  (xe[s] = u)))))
          : "none" !== n && ((l[c] = "none"), V.set(r, "display", n)));
    ...
    toggle: function (e) {
      return "boolean" == typeof e
        ? e
          ...
          : this.hide()
        : this.each(function () {
            pe(this) ? ee(this).show() : ee(this).hide();
          });
    },
  });
  var we = function (e) {
      return (
        ee.contains(e.ownerDocument, e) || e.getRootNode(Te) === e.ownerDocument
      );
    },
    Te = { composed: !0 };
  b.getRootNode ||
  ...
  (Ee.tbody = Ee.tfoot = Ee.colgroup = Ee.caption = Ee.thead), (Ee.th = Ee.td);
  var Ae = /<|&#?\w+;/;
  function qe(e, t, n, r, i) {
      ...
      if ((o = e[d]) || 0 === o)
        if ("object" === x(o)) ee.merge(p, o.nodeType ? [o] : o);
          ...
          (a = a || f.appendChild(t.createElement("div"))),
            (s = (je.exec(o) || ["", ""])[1].toLowerCase()),
            (c = (u = Ee[s] || g).length);
          while (-1 < --c) a = a.appendChild(t.createElement(u[c]));
          (a.innerHTML = ee.htmlPrefilter(o)),
    ...
    while ((o = p[d++]))
      if (r && -1 < ee.inArray(o, r)) i && i.push(o);
        ...
        ((l = Ce(o)), (a = Se(f.appendChild(o), "script")), l && De(a), n)
      ) {
        c = 0;
        while ((o = a[c++])) ke.test(o.type || "") && n.push(o);
      }
    return f;
  }
  ...
  function Me(e, i, o) {
    o
      ...
      : void 0 === V.get(e, i) && ee.event.add(e, i, Le);
  }
  (ee.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        ee.isEmptyObject(u) && V.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
      ...
      if (
        ...
        (a = ee.event.handlers.call(this, u, l)), (t = 0);
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Ne.test(t.type) && t.click && te(t, "input") && Me(t, "click", Le),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Ne.test(t.type) && t.click && te(t, "input") && Me(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
    ...
    (ee.Event = function (e, t) {
      ...
      e && e.type
        ? ((this.originalEvent = e),
          (this.type = e.type),
          (this.isDefaultPrevented = e.defaultPrevented ? Le : He),
  ...
  function Ue(n, r, i, o) {
    ...
    if ("function" == typeof d)
      return n.each(function (e) {
        var t = n.eq(e);
        (r[0] = d.call(this, e, t.html())), Ue(t, r, i, o);
      });
    if (
      f &&
      ((t = (e = qe(r, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || o)
    ) {
      for (s = (a = ee.map(Se(e, "script"), Fe)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = ee.clone(u, !0, !0)), s && ee.merge(a, Se(u, "script"))),
          i.call(n[c], u, c);
      if (s)
        for (
          l = a[a.length - 1].ownerDocument, ee.map(a, Be), c = 0;
          c < s;
          c++
        )
          (u = a[c]),
            ke.test(u.type || "") &&
              ...
              (u.src && "module" !== (u.type || "").toLowerCase()
                ...
                : m(u.textContent.replace($e, ""), u, l));
    }
    return n;
  }
  function Xe(e, t, n) {
    for (var r, i = t ? ee.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || ee.cleanData(Se(r)),
        r.parentNode &&
          (n && Ce(r) && De(Se(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  ee.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (ie && (1 === e.nodeType || 11 === e.nodeType) && !ee.isXMLDoc(e))
        for (a = Se(s), r = 0, i = (o = Se(e)).length; r < i; r++)
          te(a[r], "textarea") && (a[r].defaultValue = o[r].defaultValue);
      if (t)
        if (n)
          for (o = o || Se(e), a = a || Se(s), r = 0, i = o.length; r < i; r++)
            _e(o[r], a[r]);
        else _e(e, s);
      return (
        0 < (a = Se(s, "script")).length && De(a, !u && Se(e, "script")), s
      );
    },
    ...
    ee.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (ee.cleanData(Se(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return F(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !We.test(e) &&
              !Ee[(je.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = ee.htmlPrefilter(e);
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (ee.cleanData(Se(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Ue(
          ...
          function (e) {
            ...
            ee.inArray(this, n) < 0 &&
              (ee.cleanData(Se(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  var ze = new RegExp("^(" + le + ")(?!px)[a-z%]+$", "i");
  function Ve(e) {
    var t = e.ownerDocument.defaultView;
    return t || (t = J), t.getComputedStyle(e);
  }
  function Ye(e, t, n) {
    var r;
    return (
        ...
        : (Je[e] =
            (function (e) {
              var t = e[0].toUpperCase() + e.slice(1),
                n = Ge.length;
              while (n--) if ((e = Ge[n] + t) in Qe) return e;
            })(e) || e))
    );
  }
  ...
  function it(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += ee.css(e, n + fe[a], !0, i)),
        r
          ? ("content" === n && (u -= ee.css(e, "padding" + fe[a], !0, i)),
            "margin" !== n &&
              (u -= ee.css(e, "border" + fe[a] + "Width", !0, i)))
          : ((u += ee.css(e, "padding" + fe[a], !0, i)),
            "padding" !== n
              ? (u += ee.css(e, "border" + fe[a] + "Width", !0, i))
              : (s += ee.css(e, "border" + fe[a] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  ee.extend({
    ...
    ee.each(["height", "width"], function (e, s) {
      ee.cssHooks[s] = {
        get: function (e, t, n) {
          if (t)
            return !Ze.test(ee.css(e, "display")) ||
      ...
      (ee.cssHooks[i + o] = {
        expand: function (e) {
          for (
            ...
            n[i + fe[t] + o] = r[t] || r[t - 2] || r[0];
          return n;
        },
      }),
        "margin" !== i && (ee.cssHooks[i + o].set = rt);
    }),
    ee.fn.extend({
      css: function (e, t) {
        return F(
      ...
      run: function (e) {
        ...
        return (
          this.options.duration
            ? (this.pos = t = ee.easing[this.easing](
                e,
      ...
      _default: {
        ...
        set: function (e) {
          ee.fx.step[e.prop]
            ? ee.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!ee.cssHooks[e.prop] && null == e.elem.style[Ke(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function ft() {
    ut &&
      (!1 === C.hidden && J.requestAnimationFrame
        ? J.requestAnimationFrame(ft)
        : J.setTimeout(ft, ee.fx.interval),
      ee.fx.tick());
  }
  function pt() {
    return (
  ...
  function gt(o, e, t) {
    ...
    for (
      ...
      if ((n = gt.prefilters[r].call(l, o, c, l.opts)))
        return (
  ...
  (ee.Animation = ee.extend(gt, {
    ...
    tweener: function (e, t) {
      "function" == typeof e ? ((t = e), (e = ["*"])) : (e = e.match(H));
      ...
      function (e, t, n) {
        ...
        if ((u = !ee.isEmptyObject(t)) || !ee.isEmptyObject(d))
          for (r in (f &&
            ...
            null == (l = v && v.display) && (l = V.get(e, "display")),
          ...
          d))
            u ||
              (v
                ...
                : (v = V.access(e, "fxshow", { display: l })),
              o && (v.hidden = !g),
              g && be([e], !0),
              p.done(function () {
                for (r in (g || be([e]), V.remove(e, "fxshow"), d))
                  ee.style(e, r, d[r]);
              })),
              (u = ht(g ? v[r] : 0, r, p)),
              r in v ||
    ...
    ee.fn.extend({
      attr: function (e, t) {
        return F(this, ee.attr, e, t, 1 < arguments.length);
      },
  ...
  ee.fn.extend({
    prop: function (e, t) {
      return F(this, ee.prop, e, t, 1 < arguments.length);
    },
    ...
    ee.fn.extend({
      addClass: function (t) {
        ...
        if ("function" == typeof t)
          return this.each(function (e) {
            ee(this).addClass(t.call(this, e, xt(this)));
          });
        if ((e = bt(t)).length)
          while ((n = this[u++]))
      ...
      removeClass: function (t) {
        ...
        if ("function" == typeof t)
          return this.each(function (e) {
            ee(this).removeClass(t.call(this, e, xt(this)));
          });
      ...
      toggleClass: function (i, t) {
        return "function" == typeof i
          ? this.each(function (e) {
              ee(this).toggleClass(i.call(this, e, xt(this), t), t);
            })
          : "boolean" == typeof t
          ? t
            ? this.addClass(i)
        ...
        select: {
          ...
          set: function (e, t) {
            var n,
              ...
              a = i.length;
            while (a--)
              ((r = i[a]).selected = -1 < ee.inArray(ee(r).val(), o)) &&
                (n = !0);
  ...
  ee.extend(ee.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !c.noBubble && !y(n)) {
          for (
            s = c.delegateType || d, wt.test(s + d) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            p.push(o), (a = o);
          a === (n.ownerDocument || C) &&
            p.push(a.defaultView || a.parentWindow || J);
        }
        i = 0;
        while ((o = p[i++]) && !e.isPropagationStopped())
          (f = o),
            ...
            (l =
              (V.get(o, "events") || Object.create(null))[e.type] &&
              V.get(o, "handle")) && l.apply(o, t),
            (l = u && o[u]) &&
              l.apply &&
              X(o) &&
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              e.isPropagationStopped() && f.addEventListener(d, Tt),
              n[d](),
              e.isPropagationStopped() && f.removeEventListener(d, Tt),
  ...
  (It.href = Ct.href),
    ee.extend({
      ...
      ajaxSetup: function (e, t) {
        return t ? _t(_t(e, ee.ajaxSettings), t) : _t(ee.ajaxSettings, e);
      },
      ajaxPrefilter: Ft(Mt),
      ajaxTransport: Ft(Wt),
      ajax: function (e, t) {
        ...
        if (
          ...
          try {
            (r.href = v.url),
              (r.href = r.href),
              (v.crossDomain =
                It.protocol + "//" + It.host != r.protocol + "//" + r.host);
          } catch (e) {
            v.crossDomain = !0;
          }
        }
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)),
            v.data &&
              ...
              ((f += (kt.test(f) ? "&" : "?") + v.data), delete v.data),
            !1 === v.cache &&
              ((f = f.replace(Lt, "$1")),
              (o = (kt.test(f) ? "&" : "?") + "_=" + jt.guid++ + o)),
            (v.url = f + o)),
        v.ifModified &&
          (ee.lastModified[f] &&
    ...
    ee.each(["get", "post"], function (e, i) {
      ee[i] = function (e, t, n, r) {
        return (
          "function" == typeof t && ((r = r || n), (n = t), (t = void 0)),
          ee.ajax(
            ee.extend(
  ...
  ee.ajaxTransport(function (i) {
    ...
    ee.ajaxPrefilter("script", function (e) {
      void 0 === e.cache && (e.cache = !1), Xt(e) && (e.type = "GET");
    }),
  ...
  ee.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = zt.pop() || ee.expando + "_" + jt.guid++;
      return (this[e] = !0), e;
    },
  }),
    ee.ajaxPrefilter("jsonp", function (e, t, n) {
      ...
      return (
        ...
        n.always(function () {
          void 0 === i ? ee(J).removeProp(r) : (J[r] = i),
    ...
    (ee.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          "function" == typeof t && (t = t.call(e, n, ee.extend({}, s))),
    ...
    ee.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (
      t,
      i
    ) {
      var o = "pageYOffset" === i;
    ...
    ee.each({ Height: "height", Width: "width" }, function (a, s) {
      ee.each({ padding: "inner" + a, content: s, "": "outer" + a }, function (
        r,
        o
      ) {
  ...
  return (
    (ee.noConflict = function (e) {
      return (
        J.$ === ee && (J.$ = Gt), e && J.jQuery === ee && (J.jQuery = Yt), ee
      );
    }),
    void 0 === e && (J.jQuery = J.$ = ee),
    ee
  );
});
